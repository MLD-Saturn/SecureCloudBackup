...
dotnet publish src/SecureCloudBackup -c Release -r win-x64 --self-contained true -o publish/portable/win-x64 -p:DefineConstants=DIAGNOSTICLOG

echo "Building for Linux x64..."
dotnet publish src/SecureCloudBackup -c Release -r linux-x64 --self-contained true -o publish/portable/linux-x64 -p:DefineConstants=DIAGNOSTICLOG

echo "Building for macOS x64..."
dotnet publish src/SecureCloudBackup -c Release -r osx-x64 --self-contained true -o publish/portable/osx-x64 -p:DefineConstants=DIAGNOSTICLOG

echo "Building for macOS ARM64 (Apple Silicon)..."
dotnet publish src/SecureCloudBackup -c Release -r osx-arm64 --self-contained true -o publish/portable/osx-arm64 -p:DefineConstants=DIAGNOSTICLOG
