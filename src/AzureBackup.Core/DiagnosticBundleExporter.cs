...
/// <c>%LOCALAPPDATA%\AzureBackup</c> (a hidden folder), pick the right daily
...
///     <see cref="AzureBackup.Core.Services.FileOperationDiagnostics"/>)</item>
...
public static class DiagnosticBundleExporter
{
    ...
    /// so a concurrent writer (e.g., <see cref="AzureBackup.CrashSafeLogger"/>
    ...
    private static void WriteInfoEntry(ZipArchive archive, string dataDirectory, Guid? sessionId)
    {
        ...
        writer.WriteLine("=== AzureBackup Diagnostic Bundle ===");
