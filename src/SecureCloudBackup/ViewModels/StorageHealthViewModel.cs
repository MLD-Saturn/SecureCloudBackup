...
public partial class StorageHealthViewModel : ViewModelBase
{
    ...
    /// </summary>
    private SecureCloudBackup.Core.Services.Backends.DatabaseRepairClassification? _lastClassification;
    ...
    /// </summary>
    private SecureCloudBackup.Core.Services.Backends.DatabaseFileIntegrityResult? _lastDiagnosis;
    ...
    private async Task VerifyDatabaseFileAsync()
    {
        ...
        try
        {
            ...
            _lastClassification = result.IsHealthy
                ? null
                : SecureCloudBackup.Core.Services.Backends.DatabaseRepairClassifier
    ...
    private static string FormatDatabaseFileReport(
        SecureCloudBackup.Core.Services.Backends.DatabaseFileIntegrityResult result)
    {
    ...
    private static string FormatRepairReport(
        SecureCloudBackup.Core.Services.Backends.DatabaseRepairResult repair)
    {
        var sb = new System.Text.StringBuilder();
