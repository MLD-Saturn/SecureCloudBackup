...
public partial class OperationPreviewViewModel : ObservableObject
{
    ...
    /// </summary>
    public string TransferSize => SecureCloudBackup.Core.FormatHelper.FormatBytes(_preview.TotalBytesToTransfer);

    /// <summary>
    /// Total bytes to delete formatted (included files only).
    /// </summary>
    public string DeleteSize => SecureCloudBackup.Core.FormatHelper.FormatBytes(_preview.TotalBytesToDelete);
