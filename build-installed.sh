...
dotnet publish src/AzureBackup -c Release -r win-x64 --self-contained true -o publish/installed/win-x64

echo "Building for Linux x64..."
dotnet publish src/AzureBackup -c Release -r linux-x64 --self-contained true -o publish/installed/linux-x64

echo "Building for macOS x64..."
dotnet publish src/AzureBackup -c Release -r osx-x64 --self-contained true -o publish/installed/osx-x64

echo "Building for macOS ARM64 (Apple Silicon)..."
dotnet publish src/AzureBackup -c Release -r osx-arm64 --self-contained true -o publish/installed/osx-arm64
